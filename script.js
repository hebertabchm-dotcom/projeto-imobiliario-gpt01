...
export function FooterLux() {
  ...
  return (
    <footer className="footer-lux" aria-label="Rodapé">
      <div className="container footer-lux__inner">
        {/* COL 1 */}
        <div className="footer-lux__brand">
          <div className="footer-lux__logo">LuxPrime</div>

          <p className="footer-lux__desc">
            Curadoria de imóveis de alto padrão com atendimento consultivo,
            discrição e acompanhamento completo do primeiro contato à entrega das chaves.
          </p>

          <div className="footer-lux__cta">
            <a
              className="btn btn--soft"
              href="https://wa.me/5521999999999?text=Ol%C3%A1!%20Quero%20uma%20curadoria%20de%20im%C3%B3veis%20de%20alto%20padr%C3%A3o."
              target="_blank"
            ...
            <a
              className="btn btn--soft"
              href="https://instagram.com/luxprime.imoveis"
              target="_blank"
              rel="noopener noreferrer"
            >
              Instagram
          ...
          <div className="footer-lux__mini">
            <span className="micro">Alto padrão • Curadoria • Discrição</span>
          </div>
        </div>

        {/* COL 2 */}
        <div className="footer-lux__col">
          <div className="footer-lux__title small">Contato</div>

          <div className="footer-lux__item">
            <div className="footer-lux__k micro">Telefone</div>
            <a className="footer-lux__v" href="tel:+5521999999999">(21) 99999-9999</a>
            <br />
            <a className="footer-lux__v" href="tel:+552121212121">(21) 2121-2121</a>
          </div>

          <div className="footer-lux__item">
            <div className="footer-lux__k micro">E-mail</div>
            <a className="footer-lux__v" href="mailto:contato@luxprimeimoveis.com.br">
              contato@luxprimeimoveis.com.br
            </a>
          </div>

          <div className="footer-lux__item">
            <div className="footer-lux__k micro">Horário</div>
            <div className="footer-lux__v">
              Seg–Sex: 09:00–19:00
              <br />
              Sáb: 09:00–14:00
            </div>
        ...
        {/* COL 3 */}
        <div className="footer-lux__col">
          <div className="footer-lux__title small">Endereço</div>

          <div className="footer-lux__item">
            <div className="footer-lux__k micro">Showroom</div>
            <div className="footer-lux__v">
              Av. Atlântica, 1500 — Sala 1203
              <br />
          ...
          <a className="footer-lux__link" href="#" aria-label="Abrir no mapa">
        ...
        {/* COL 4 */}
        <div className="footer-lux__col">
          <div className="footer-lux__title small">Informações</div>

          <nav className="footer-lux__links" aria-label="Links do rodapé">
            <a className="footer-lux__link" href="#imoveis">Imóveis</a>
            <a className="footer-lux__link" href="#curadoria">Curadoria</a>
            <a className="footer-lux__link" href="#depoimentos">Depoimentos</a>
            <a className="footer-lux__link" href="#contato">Agendar visita</a>
          </nav>

          <div className="footer-lux__legal">
            <div className="micro">CRECI: RJ-00000</div>
            <div className="micro">CNPJ: 00.000.000/0001-00</div>
            <div className="micro">Política de privacidade • Termos</div>
          </div>
        </div>
      </div>

      <div className="container footer-lux__bottom">
        <div className="micro">© {year} LuxPrime Imóveis. Todos os direitos reservados.</div>
        <div className="micro">Estética editorial • UX premium</div>
      </div>
    </footer>
  );
}
...
export function WhatsAppFloat() {
  return (
    ...
    >
      ...
      <span className="wa-float__icon" aria-hidden="true">WA</span>
      <span className="wa-float__label">Atendimento VIP</span>
    </a>
  );
}
